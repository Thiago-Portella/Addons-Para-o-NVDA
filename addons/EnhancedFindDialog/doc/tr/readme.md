# NVDA için Gelişmiş Ara İletişim Kutusu 1.5.1
...
## İndirme:  
[Gelişmiş Ara İletişim Kutusu 1.5.1 eklentisini indirin](https://github.com/marlon-sousa/EnhancedFindDialog/releases/download/1.5.1/EnhancedFindDialog-1.5.1.nvda-addon)
