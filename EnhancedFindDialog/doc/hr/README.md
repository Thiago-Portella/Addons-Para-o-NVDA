# Poboljšani dijaloški okvir traženja za NVDA1.7.0
...
## Preuzimanje
Preuzmite Poboljšani dijaloški okvir traženja 1.7.0 dodatak](https://github.com/marlon-sousa/EnhancedFindDialog/releases/download/1.7.0/EnhancedFindDialog-1.7.0.nvda-addon)
