# NVDA için Gelişmiş Ara İletişim Kutusu 1.7.0
...
## İndirme:  
[Gelişmiş Ara İletişim Kutusu 1.7.0 eklentisini indirin](https://github.com/marlon-sousa/EnhancedFindDialog/releases/download/1.7.0/EnhancedFindDialog-1.7.0.nvda-addon)
