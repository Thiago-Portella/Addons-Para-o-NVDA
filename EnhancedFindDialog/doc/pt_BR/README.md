# EnhancedFindDialog para NVDA 1.7.0
...
## Download
Baixe o [Complemento para o Diálogo de Busca Estendido 1.7.0](https://github.com/marlon-sousa/EnhancedFindDialog/releases/download/1.7.0/EnhancedFindDialog-1.7.0.nvda-addon)
