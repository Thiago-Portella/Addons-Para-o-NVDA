...
anki = "H:\Meu Drive\coisas do thiago\Documents\estudo de inglês\Aulas de inglês professora Sofia\\textos de estudo\\anki.txt"

def saveText(text,  translated):
        file = open(anki, "a")
        file.write(text + "\n")
